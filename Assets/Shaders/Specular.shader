...
Shader "Toony Colors Pro 2/User/Specular"
{
	Properties
	{
		...
		_SpecularToonSize ("Toon Size", Range(-1,1)) = 0.25
		_SpecularToonSmoothness ("Toon Smoothness", Range(-1,0.5)) = 0.05
		[TCP2Separator]
